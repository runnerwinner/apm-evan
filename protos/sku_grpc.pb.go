...
type SkuServiceClient interface {
	DecreaseStock(ctx context.Context, in *SkuMsg, opts ...grpc.CallOption) (*SkuMsg, error)
}
...
func (c *skuServiceClient) DecreaseStock(ctx context.Context, in *SkuMsg, opts ...grpc.CallOption) (*SkuMsg, error) {
...
type SkuServiceServer interface {
	DecreaseStock(context.Context, *SkuMsg) (*SkuMsg, error)
...
func (UnimplementedSkuServiceServer) DecreaseStock(context.Context, *SkuMsg) (*SkuMsg, error) {
...
func _SkuService_DecreaseStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SkuServiceServer).DecreaseStock(ctx, req.(*SkuMsg))
	}
